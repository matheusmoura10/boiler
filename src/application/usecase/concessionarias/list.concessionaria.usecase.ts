...
@injectable()
export default class ListConcessionariaUsecase extends UseCase<InputListaPaginada, OutputListaPaginada<ConcessionariaEntity>> {
    constructor(
    ...
    async execute(input: InputListaPaginada): Promise<OutputListaPaginada<ConcessionariaEntity>> {
