...
export default class ConcessionariaFactory {
    ...
    static modelToEntity(concessionaria: ConcessionariaModel): ConcessionariaEntity {
        return new ConcessionariaEntity(concessionaria.id, concessionaria.nome, concessionaria.estado)
    }
}
