...
const fazendaPost = z.object({
    body: z.object({
        ...
        dataConexao: z.string().refine((data) => {
            ...
            message: "A data de conexão deve ser uma data válida no formato 'YYYY-MM-DD'"
        }),
        ...
        concessionaria: z.object({
            id: z.string(
                {
                    required_error: "O id da concessionária é obrigatório",
                    invalid_type_error: "O id da concessionária deve ser um texto",
                }
            )
        }, {
            required_error: "A concessionária é obrigatória",
            invalid_type_error: "A concessionária deve ser um objeto"
        }),
    })
});
